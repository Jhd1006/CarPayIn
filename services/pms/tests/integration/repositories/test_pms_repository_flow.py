...
def test_pms_tables_can_store_and_load_data_from_postgres():
    ...
    try:
        ...
        pms_session_repository.mark_paid(pms_session_id)
        assert pms_session_repository.get_session_by_id(pms_session_id)["status"] == "paid"
        ...
        pms_session_repository.mark_exited(pms_session_id)
